                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" method="post">                                          
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" id="text1" name="sube_isim" class="form-control" /><br>
                                        </div>
                                            
                                        <label for="limiter" class="control-label col-lg-4" >Şube Hakkında</label><br>
                                        <div class="col-lg-8">
                                            <textarea id="limiter" name="sube_hakkinda" class="form-control" rows="8"></textarea><br>
                                        </div>

                                        <label for="limiter1" class="control-label col-lg-4">Şube İletişim</label><br>
                                        <div class="col-lg-8">
                                            <textarea id="limiter1" name="sube_iletisim" class="form-control" rows="8"></textarea><br>
                                        </div>
                                </div>
